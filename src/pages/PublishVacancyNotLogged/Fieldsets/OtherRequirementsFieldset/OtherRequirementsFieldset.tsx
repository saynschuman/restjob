...
export class OtherRequirementsFieldset extends React.PureComponent<
  OtherRequirementsFieldsetProps,
  OtherRequirementsFieldsetState
> {
  state = {
    listsVisible: false,
  }
  ...
  render() {
    return (
      <PublishVacancyFieldset
        {...this.props}
        titleText={__t("publishVacancyPage.listItem6")}
      >
        <div className={CSS.otherRequirementsText}>
          {__t("publishVacancyPage.otherRequirementsText")}
        </div>
